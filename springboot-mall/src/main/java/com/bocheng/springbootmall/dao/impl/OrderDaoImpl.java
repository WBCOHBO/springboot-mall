...
import com.bocheng.springbootmall.dao.OrderDao;
import com.bocheng.springbootmall.model.Order;
import com.bocheng.springbootmall.model.OrderItem;
import com.bocheng.springbootmall.rowmapper.OrderItemRowMapper;
import com.bocheng.springbootmall.rowmapper.OrderRowMapper;
...
public class OrderDaoImpl implements OrderDao {
    ...
    public void createOrderItems(Integer orderId, List<OrderItem> orderItemList) {
        //使用 for loop一條一條 sql加入數據，效率低
//        for (OrderItem orderItem: orderItemList){
//            String sql = "INSERT INTO order_item(order_id, product_id, quantity, amount) " +
//                    "VALUES (:orderId, :productId, :quantity, :amount)";
//            Map<String, Object> map = new HashMap<>();
//            map.put("orderId", orderId);
//            map.put("productId", orderItem.getOrderItemId());
